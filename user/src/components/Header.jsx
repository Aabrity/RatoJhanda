...
//       {/* Wrap input + button inside form to submit */}
//       <form onSubmit={handleSubmit} className="flex items-center">
//         <TextInput
//           type="text"
//           placeholder="Search..."
//           rightIcon={null} // remove icon from input, use button instead
//           value={searchTerm}
//           onChange={(e) => setSearchTerm(e.target.value)}
//           className="hidden lg:inline w-80"
//           theme={{
...
//                     ? 'bg-gray-800 border-red-500 text-white'
//                     : 'bg-white border-red-400 text-black'
//                 } text-sm rounded-l-lg block w-full p-2.5`,
//                 colors: {
//                   gray: 'focus:ring-red-500 focus:border-red-500',
//                 },
//               },
...
//           type="submit"
//           color="failure"
//           className="w-12 h-10 rounded-r-lg hidden lg:flex items-center justify-center focus:ring-red-500 hover:ring-red-500 focus:ring-2 focus:outline-none"

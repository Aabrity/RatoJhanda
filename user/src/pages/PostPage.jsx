...
//   const { currentUser } = useSelector((state) => state.user); // for auth header if desired
...
//           {/* Report Post button (top‑left area) */}
//           <Button
//             color="failure"
//             size="xs"
...
// import L from 'leaflet';
// import 'leaflet/dist/leaflet.css';
// import { FaShare } from 'react-icons/fa'; // NEW: Share icon
...
//       {/* Share Button */}
//       <div
//         className="fixed top-[13%] right-[3%] z-50 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer"
//         onClick={() => {
//           navigator.clipboard.writeText(window.location.href);
//           setCopied(true);
//           setTimeout(() => setCopied(false), 2000);
...
//       </div>
//       {copied && (
//         <p className="fixed top-[23%] right-[5%] z-50 rounded-md bg-slate-100 px-3 py-1 text-sm shadow">
//           Link copied!
//         </p>
//       )}

...
//           src={post.images[0]}
//           alt={post.title}
//           className='mt-8 p-3 max-h-[600px] w-full object-cover rounded-lg shadow-md'
//         />
//       ) : (
//         <div className='mt-8 p-3 text-center text-gray-500 italic'>
//           No image uploaded.
//         </div>
//       )}

//       {/* Metadata */}
//       <div className='flex flex-col sm:flex-row justify-between p-3 border-b border-slate-500 mx-auto w-full max-w-2xl text-xs'>
...
//       {/* Post Info */}
//       <div className='p-3 max-w-2xl mx-auto w-full text-sm text-gray-700 space-y-2'>
//         <p><strong>Location:</strong> {post.location}</p>
//         <p>
//           <strong>Flag:</strong>{' '}
//           <span
//             className={`px-2 py-1 rounded-full text-white text-xs font-semibold ${
//               post.flag === 'redflag' ? 'bg-red-600' : 'bg-green-600'
//             }`}
//           >
//             {post.flag === 'redflag' ? 'Red Flag' : 'Green Flag'}
//           </span>
//         </p>
//         {post.isAnonymous && (
//           <p className='italic text-gray-500'>(Posted anonymously)</p>
//         )}
//         {post.geolocation && (
//           <p>
//             <strong>Coordinates:</strong> Lat {post.geolocation.lat}, Lng {post.geolocation.lng}
//           </p>
//         )}
//       </div>
...
// // Custom marker based on flag
// const getMarkerIcon = (flag) => {
//   const color = flag === 'redflag' ? 'red' : 'green';
//   return new L.Icon({
...
//   const markerIcon = getMarkerIcon(post.flag);
...
//       {/* Post Info */}
//       <div className='p-3 max-w-2xl mx-auto w-full text-sm text-gray-700 space-y-2'>
//         <p><strong>Posted By:</strong> {post.isAnonymous ? 'Anonymous' : post.userName || 'Unknown User'}</p>
//         <p><strong>Location:</strong> {post.location}</p>
//         <p>
//           <strong>Flag:</strong>{' '}
//           <span
...
//       {/* Map Display */}
//       {post.geolocation && (
//         <div className='p-3 max-w-4xl mx-auto w-full h-[400px] mt-5 rounded-lg overflow-hidden'>
//           <MapContainer
